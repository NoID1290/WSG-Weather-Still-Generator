...
│   ├── Program.cs                  # Entry point & main logic
│   ├── ConfigManager.cs            # Configuration system
│   ├── ECCC.cs                     # Environment Canada integration
│   ├── VideoGenerator.cs           # MP4 video creation
│   ├── appsettings.json            # Configuration file
│   ├── CONFIG_README.md            # Configuration documentation
│   └── WeatherImageGenerator.csproj
├── OpenMeteo/                      # Weather API library
│   ├── OpenMeteoClient.cs          # API client wrapper
│   └── *.cs                        # Domain models
...
👉 **See [CONFIG_README.md](./CONFIG_README.md) for complete configuration documentation**
...
┌──────────────────────────────────────┐
│  Fetch Weather Data                  │
│  - OpenMeteo API (7 locations)       │
│  - ECCC RSS Feeds (alerts)           │
└────────┬─────────────────────────────┘
         │
         v
┌──────────────────────────────────────┐
...
└────────┬─────────────────────────────┘
         ...
         v
┌──────────────────────────────────────┐
│  Output to WeatherImages/ folder     │
│  - PNG images ready for display      │
│  - MP4 video for streaming           │
└──────────────────────────────────────┘
         │
         v
    [Wait & Repeat]
