...
namespace ECCC.Api
{
    ...
    public static class UrlBuilder
    {
        ...
        public static string BuildAlertsUrl(double latitude, double longitude, string language = "f")
            => string.Format(System.Globalization.CultureInfo.InvariantCulture, "{0}/rss/alerts/{1:F3}_{2:F3}_{3}.xml", BaseWeatherUrl, latitude, longitude, language);
    ...
    public static class WmsLayers
    {
        ...
        // Lightning layers
        /// <summary>5-minute lightning flash density (all discharges)</summary>
        public const string LightningFlashDensity = "LIGHTNING_2.5KM_DENSITY-FLASHES_5MIN";
        /// <summary>5-minute cloud-to-ground flash density</summary>
        public const string LightningCgDensity = "LIGHTNING_2.5KM_DENSITY-CG_5MIN";
    }
